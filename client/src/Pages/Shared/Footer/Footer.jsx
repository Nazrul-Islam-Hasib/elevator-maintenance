const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
            <aside>
                ...
                <p className="font-bold">
                    Elevator Maintanence. <br />Providing reliable service since 1992
                </p>
